            ...
            <td colspan="2">
                <table width = "100%" cellspacing = "0" cellpadding = "0">
                    <tr>
                        ...
                        <td>
                            <h1 align = "center" >
                               <font color = "#333" > <b> WORLD’S BEST CLOTHING STORES  <br>THE FASHIONISTA RANKING  </b> </font>
                            </h1>
                        </td>
                    </tr>
                </table>
    ...
    <div class = "nav-bar">
        <div id = "menu">
            <ul class="show-nav">
                ...
                <li>
                    <a href="https://www.facebook.com/" target="_blank">CONTACT ME</a>
                </li>
                <li>
